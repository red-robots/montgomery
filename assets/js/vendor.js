...
!function (e, t) {
        ...
        if (A = 0, p[_i3] && (_r2 = p[_i3]), L && e.grid.updateSlide(_i3, _r2, m, t), !p[_i3] || "none" !== w(_r2, "display")) {
          if ("auto" === a.slidesPerView) {
            ...
            if (_l && (_r2.style.transform = "none"), _o && (_r2.style.webkitTransform = "none"), a.roundLengths) A = e.isHorizontal() ? x(_r2, "width", !0) : x(_r2, "height", !0);else {
              var _e2 = s(_n, "width"),
                _t2 = s(_n, "padding-left"),
                _a3 = s(_n, "padding-right"),
    ...
    return _createClass(Q, [{
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        if (s.centeredSlides) {
          ...
          for (var _s17 = l + 1; _s17 < a.length; _s17 += 1) a[_s17] && !_e30 && (_t20 += a[_s17].swiperSlideSize, o += 1, _t20 > n && (_e30 = !0));
          for (var _s18 = l - 1; _s18 >= 0; _s18 -= 1) a[_s18] && !_e30 && (_t20 += a[_s18].swiperSlideSize, o += 1, _t20 > n && (_e30 = !0));
    ...
    s({
      ...
      if (t.params.observer) {
        if (t.params.observeParents) {
          var _e37 = y(t.el);
          for (var _t26 = 0; _t26 < _e37.length; _t26 += 1) o(_e37[_t26]);
        }
        o(t.el, {
  ...
  var ce = [function (e) {
    ...
    function u() {
      ...
      if (a = t.params.loop ? t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex : void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
        ...
        if (s.dynamicBullets && (n = x(_i12[0], t.isHorizontal() ? "width" : "height", !0), r.forEach(function (e) {
          ...
          var t = b(e);
          t === a && e.classList.add(s.bulletActiveClass), s.dynamicBullets && (t >= _o6 && t <= _d3 && e.classList.add("".concat(s.bulletActiveClass, "-main")), t === _o6 && c(e, "prev"), t === _d3 && c(e, "next"));
        });else {
          var _e44 = _i12[a];
          if (_e44 && _e44.classList.add(s.bulletActiveClass), s.dynamicBullets) {
            var _e45 = _i12[_o6],
              _t36 = _i12[_d3];
            for (var _e46 = _o6; _e46 <= _d3; _e46 += 1) _i12[_e46].classList.add("".concat(s.bulletActiveClass, "-main"));
      ...
      r.forEach(function (e, r) {
        if ("fraction" === s.type && (e.querySelectorAll(ee(s.currentClass)).forEach(function (e) {
          ...
          var _n6 = 1,
            _l8 = 1;
          "horizontal" === _i13 ? _n6 = _r9 : _l8 = _r9, e.querySelectorAll(ee(s.progressbarFillClass)).forEach(function (e) {
    ...
    function c(e) {
      ...
      }), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e53 = 0; _e53 < i; _e53 += 1) f(s.slidesEl, "[data-swiper-slide-index=\"".concat(t.realIndex + _e53, "\"]")).forEach(function (e) {
        e.classList.add(r);
      });else for (var _e54 = 0; _e54 < i; _e54 += 1) s.slides[t.realIndex + _e54] && s.slides[t.realIndex + _e54].classList.add(r);
          ...
          if (s < -t.minTranslate()) t.slideTo(t.activeIndex);else if (s > -t.maxTranslate()) t.slides.length < d.length ? t.slideTo(d.length - 1) : t.slideTo(t.slides.length - 1);else {
            if (r.freeMode.momentum) {
              if (c.velocities.length > 1) {
                var _e56 = c.velocities.pop(),
                  _s38 = c.velocities.pop(),
                  _a20 = _e56.position - _s38.position,
                  _i19 = _e56.time - _s38.time;
                t.velocity = _a20 / _i19, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i19 > 150 || l() - _e56.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
              ...
              if (_p4 < t.maxTranslate()) r.freeMode.momentumBounce ? (_p4 + t.maxTranslate() < -_h && (_p4 = t.maxTranslate() - _h), _u2 = t.maxTranslate(), _m = !0, c.allowMomentumBounce = !0) : _p4 = t.maxTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (_p4 > t.minTranslate()) r.freeMode.momentumBounce ? (_p4 - t.minTranslate() > _h && (_p4 = t.minTranslate() + _h), _u2 = t.minTranslate(), _m = !0, c.allowMomentumBounce = !0) : _p4 = t.minTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (r.freeMode.sticky) {
                var _e58;
                for (var _t39 = 0; _t39 < d.length; _t39 += 1) if (d[_t39] > -_p4) {
                  _e58 = _t39;
                  break;
                }
              ...
              if (_f && i("transitionEnd", function () {
                ...
                if (_e57 = o ? Math.abs((-_p4 - t.translate) / t.velocity) : Math.abs((_p4 - t.translate) / t.velocity), r.freeMode.sticky) {
                  var _s40 = Math.abs((o ? -_p4 : _p4) - t.translate),
                    _a21 = t.slidesSizesGrid[t.activeIndex];
                  _e57 = _s40 < _a21 ? r.speed : _s40 < 2 * _a21 ? 1.5 * r.speed : 2.5 * r.speed;
                }
              } else if (r.freeMode.sticky) return void t.slideToClosest();
              r.freeMode.momentumBounce && _m ? (t.updateProgress(_u2), t.setTransition(_e57), t.setTranslate(_p4), t.transitionStart(!0, t.swipeDirection), t.animating = !0, E(n, function () {
              ...
              })) : t.velocity ? (a("_freeModeNoMomentumRelease"), t.updateProgress(_p4), t.setTransition(_e57), t.setTranslate(_p4), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, E(n, function () {
                t && !t.destroyed && t.transitionEnd();
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _s42 = 0; _s42 < e.length; _s42 += 1) {
          ...
          var _r14 = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e60.progress), 0) : 1 + Math.min(Math.max(_e60.progress, -1), 0),
            _n7 = le(0, _e60);
          _n7.style.opacity = _r14, _n7.style.transform = "translate3d(".concat(_a24, "px, ").concat(_i21, "px, 0px)");
        }
      },
    ...
    ne({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e61 = 0; _e61 < a.length; _e61 += 1) {
          ...
          var _d4 = Math.max(Math.min(_t41.progress, 1), -1);
          var _m2 = 0,
            _f2 = 0,
            _g = 0;
          ...
          _d4 <= 1 && _d4 > -1 && (h = 90 * _s43 + 90 * _d4, l && (h = 90 * -_s43 - 90 * _d4)), _t41.style.transform = _v, c.slideShadows && i(_t41, _d4, p);
        }
...
!function (e, t) {
  ...
  var B = {
      ...
      update: {
        ...
        updateSlidesProgress: function updateSlidesProgress() {
          ...
          for (var _e26 = 0; _e26 < a.length; _e26 += 1) {
            var _n4 = a[_e26];
            var _l4 = _n4.swiperSlideOffset;
            s.cssMode && s.centeredSlides && (_l4 -= a[0].swiperSlideOffset);
            var _o4 = (r + (s.centeredSlides ? t.minTranslate() : 0) - _l4) / (_n4.swiperSlideSize + s.spaceBetween),
              _d2 = -(r - _l4),
              _c2 = _d2 + t.slidesSizesGrid[_e26];
            (_d2 >= 0 && _d2 < t.size - 1 || _c2 > 1 && _c2 <= t.size || _d2 <= 0 && _c2 >= t.size) && (t.visibleSlides.push(_n4), t.visibleSlidesIndexes.push(_e26), a.eq(_e26).addClass(s.slideVisibleClass)), _n4.progress = i ? -_o4 : _o4;
          }
        ...
        updateActiveIndex: function updateActiveIndex(e) {
          ...
          var d,
            c = e;
          if (void 0 === c) {
            for (var _e27 = 0; _e27 < a.length; _e27 += 1) void 0 !== a[_e27 + 1] ? s >= a[_e27] && s < a[_e27 + 1] - (a[_e27 + 1] - a[_e27]) / 2 ? c = _e27 : s >= a[_e27] && s < a[_e27 + 1] && (c = _e27 + 1) : s >= a[_e27] && (c = _e27);
        ...
        updateClickedSlide: function updateClickedSlide(e) {
          ...
          var i,
            r = !1;
          if (a) for (var _e29 = 0; _e29 < t.slides.length; _e29 += 1) if (t.slides[_e29] === a) {
            r = !0, i = _e29;
            break;
          }
          if (!a || !r) return t.clickedSlide = void 0, void (t.clickedIndex = void 0);
        ...
        translateTo: function translateTo() {
          ...
          if (c = a && e > o ? o : a && e < d ? d : e, r.updateProgress(c), n.cssMode) {
            ...
            if (0 === t) l[_e30 ? "scrollLeft" : "scrollTop"] = -c;else {
              ...
              l.scrollTo(_defineProperty(_defineProperty({}, _e30 ? "left" : "top", -c), "behavior", "smooth"));
            }
            return !0;
          }
          return 0 === t ? (r.setTransition(0), r.setTranslate(c), s && (r.emit("beforeTransitionStart", t, i), r.emit("transitionEnd"))) : (r.setTransition(t), r.setTranslate(c), s && (r.emit("beforeTransitionStart", t, i), r.emit("transitionStart")), r.animating || (r.animating = !0, r.onTranslateToWrapperTransitionEnd || (r.onTranslateToWrapperTransitionEnd = function (e) {
        ...
        slideTo: function slideTo() {
          ...
          if (l.cssMode) {
            ...
            if (0 === t) {
              ...
              _t23 && (r.wrapperEl.style.scrollSnapType = "none"), h[_e32 ? "scrollLeft" : "scrollTop"] = _s24, _t23 && requestAnimationFrame(function () {
              ...
              h.scrollTo(_defineProperty(_defineProperty({}, _e32 ? "left" : "top", _s24), "behavior", "smooth"));
            }
            return !0;
          }
      ...
      loop: {
        loopCreate: function loopCreate() {
          ...
          for (var _e38 = 0; _e38 < l.length; _e38 += 1) i.append(d(l[_e38].cloneNode(!0)).addClass(s.slideDuplicateClass));
          for (var _e39 = n.length - 1; _e39 >= 0; _e39 -= 1) i.prepend(d(n[_e39].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
    ...
    return _createClass(H, [{
      ...
      value: function slidesPerViewDynamic() {
        ...
        if (s.centeredSlides) {
          ...
          for (var _s27 = l + 1; _s27 < a.length; _s27 += 1) a[_s27] && !_e44 && (_t26 += a[_s27].swiperSlideSize, o += 1, _t26 > n && (_e44 = !0));
          for (var _s28 = l - 1; _s28 >= 0; _s28 -= 1) a[_s28] && !_e44 && (_t26 += a[_s28].swiperSlideSize, o += 1, _t26 > n && (_e44 = !0));
  ...
  function _(e, t) {
    ...
    if ("object" == _typeof(t) && "length" in t) {
      for (var _e49 = 0; _e49 < t.length; _e49 += 1) t[_e49] && a.append(t[_e49]);
      o = n > e ? n + t.length : n;
    } else a.append(t);
    for (var _e50 = 0; _e50 < d.length; _e50 += 1) a.append(d[_e50]);
  ...
  function K(_ref4) {
    ...
    if (e.params.virtualTranslate && 0 !== t) {
      ...
      _t31 = a ? s ? i.find(s) : i : s ? i.eq(r).find(s) : i.eq(r), _t31.transitionEnd(function () {
        ...
        for (var _e51 = 0; _e51 < t.length; _e51 += 1) n.trigger(t[_e51]);
      });
    }
  }
  function Z(e, t, s) {
    ...
    t({
      ...
      if (e.params.observer) {
        if (e.params.observeParents) {
          ...
          for (var _e52 = 0; _e52 < _t32.length; _e52 += 1) l(_t32[_e52]);
        }
        l(e.$el[0], {
  ...
  var J = [function (_ref8) {
    ...
    function i(t) {
      ...
      for (var _e53 = 0; _e53 < c.length; _e53 += 1) _e53 >= v && _e53 <= w && (void 0 === d || t ? E.push(_e53) : (_e53 > d && E.push(_e53), _e53 < o && y.push(_e53)));
      ...
      if (v >= e.minTranslate() && (v = e.minTranslate()), v <= e.maxTranslate() && (v = e.maxTranslate()), i = !!e.params.loop || !(v === e.minTranslate() || v === e.maxTranslate()), i && e.params.nested && s.stopPropagation(), e.params.freeMode && e.params.freeMode.enabled) {
        ...
        if (!_i10) {
          ...
          var _d4 = e.isBeginning,
            _u = e.isEnd;
          if (_o6 >= e.minTranslate() && (_o6 = e.minTranslate()), _o6 <= e.maxTranslate() && (_o6 = e.maxTranslate()), e.setTransition(0), e.setTranslate(_o6), e.updateProgress(), e.updateActiveIndex(), e.updateSlidesClasses(), (!_d4 && e.isBeginning || !_u && e.isEnd) && e.updateSlidesClasses(), e.params.freeMode.sticky) {
    ...
    function c() {
      ...
      if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > i - 1 - 2 * e.loopedSlides && (p -= i - 2 * e.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== e.params.paginationType && (p = u + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
        ...
        var _i11, _l6, _u2;
        if (s.dynamicBullets && (r = _a20.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", r * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (n += p - e.previousIndex, n > s.dynamicMainBullets - 1 ? n = s.dynamicMainBullets - 1 : n < 0 && (n = 0)), _i11 = p - n, _l6 = _i11 + (Math.min(_a20.length, s.dynamicMainBullets) - 1), _u2 = (_l6 + _i11) / 2), _a20.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(function (e) {
          return "".concat(s.bulletActiveClass).concat(e);
          ...
          if (_t39.addClass(s.bulletActiveClass), s.dynamicBullets) {
            var _t40 = _a20.eq(_i11),
              _n8 = _a20.eq(_l6);
            for (var _e55 = _i11; _e55 <= _l6; _e55 += 1) _a20.eq(_e55).addClass("".concat(s.bulletActiveClass, "-main"));
            if (e.params.loop) {
              if (_r8 >= _a20.length - s.dynamicMainBullets) {
                for (var _e56 = s.dynamicMainBullets; _e56 >= 0; _e56 -= 1) _a20.eq(_a20.length - _e56).addClass("".concat(s.bulletActiveClass, "-main"));
    ...
    function o() {
      ...
      });else if (c > 1) for (var _e59 = i; _e59 < i + c; _e59 += 1) p(_e59) && l(_e59);else l(i);
      if (o.loadPrevNext) if (c > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
        ...
        for (var _e61 = i + c; _e61 < _s40; _e61 += 1) p(_e61) && l(_e61);
        for (var _e62 = _r10; _e62 < i; _e62 += 1) p(_e62) && l(_e62);
      } else {
    ...
    t({
      ...
      setTranslate: function setTranslate(t, s) {
        ...
        if (Array.isArray(i)) for (var _e65 = 0; _e65 < i.length; _e65 += 1) i[_e65] !== s && i[_e65] instanceof l && o(i[_e65]);else i instanceof l && s !== i && o(i);
      },
          ...
          if (t < -e.minTranslate()) e.slideTo(e.activeIndex);else if (t > -e.maxTranslate()) e.slides.length < l.length ? e.slideTo(l.length - 1) : e.slideTo(e.slides.length - 1);else {
            if (i.freeMode.momentum) {
              ...
              if (_c4 < e.maxTranslate()) i.freeMode.momentumBounce ? (_c4 + e.maxTranslate() < -_m && (_c4 = e.maxTranslate() - _m), _p = e.maxTranslate(), _h = !0, o.allowMomentumBounce = !0) : _c4 = e.maxTranslate(), i.loop && i.centeredSlides && (_f = !0);else if (_c4 > e.minTranslate()) i.freeMode.momentumBounce ? (_c4 - e.minTranslate() > _m && (_c4 = e.minTranslate() + _m), _p = e.minTranslate(), _h = !0, o.allowMomentumBounce = !0) : _c4 = e.minTranslate(), i.loop && i.centeredSlides && (_f = !0);else if (i.freeMode.sticky) {
                var _t55;
                for (var _e66 = 0; _e66 < l.length; _e66 += 1) if (l[_e66] > -_c4) {
                  _t55 = _e66;
                  break;
                }
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _i22 = 0; _i22 < t.length; _i22 += 1) {
          ...
          var _o9 = -180 * _n12,
            ...
            _p2 = 0;
          if (e.isHorizontal() ? s && (_o9 = -_o9) : (_p2 = _c5, _c5 = 0, _d6 = -_o9, _o9 = 0), _r16[0].style.zIndex = -Math.abs(Math.round(_n12)) + t.length, a.slideShadows) {
          ...
          var _u3 = "translate3d(".concat(_c5, "px, ").concat(_p2, "px, 0px) rotateX(").concat(_d6, "deg) rotateY(").concat(_o9, "deg)");
      ...
      setTranslate: function setTranslate() {
        ...
        var _loop = function _loop() {
          ...
          if (u && h.shadow || !u) {
            ...
            if (0 === _e73.length && h.shadow && (_e73 = Z(s, n)), _e73.length) {
